	...
	<div class="col-sm-12">
		<div class="pull-left">
			<shiro:hasPermission name="car:car:add">
				<table:addRow url="${ctx}/car/car/form" title="1"></table:addRow><!-- 增加按钮 -->
			</shiro:hasPermission>
			<shiro:hasPermission name="car:car:edit">
			    <table:editRow url="${ctx}/car/car/form" title="1" id="contentTable"></table:editRow><!-- 编辑按钮 -->
			</shiro:hasPermission>
	...
	<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
		...
		<c:forEach items="${page.list}" var="car">
			<tr>
				...
				<td><a  href="#" onclick="openDialogView('查看1', '${ctx}/car/car/form?id=${car.id}','800px', '500px')">
					${car.remarks}
				</a></td>
				<td>
					${car.price}
				...
				<td>
					<shiro:hasPermission name="car:car:view">
						<a href="#" onclick="openDialogView('查看1', '${ctx}/car/car/form?id=${car.id}','800px', '500px')" class="btn btn-info btn-xs" ><i class="fa fa-search-plus"></i> 查看</a>
					</shiro:hasPermission>
					<shiro:hasPermission name="car:car:edit">
    					<a href="#" onclick="openDialog('修改1', '${ctx}/car/car/form?id=${car.id}','800px', '500px')" class="btn btn-success btn-xs" ><i class="fa fa-edit"></i> 修改</a>
    				</shiro:hasPermission>
    				<shiro:hasPermission name="car:car:del">
						<a href="${ctx}/car/car/delete?id=${car.id}" onclick="return confirmx('确认要删除该1吗？', this.href)"   class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> 删除</a>
					</shiro:hasPermission>
				</td>
			</tr>
		</c:forEach>
